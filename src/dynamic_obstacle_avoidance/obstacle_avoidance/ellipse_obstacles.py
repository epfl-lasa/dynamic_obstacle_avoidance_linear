...
class Ellipse(Obstacle):
    ...
    def get_surface_derivative_angle(self, angle_space, in_global_frame=False):
        ...
        derivative = direction_perp*local_radius - 0.5*direction * (local_radius*local_radius) *self.get_radius_derivative_direction(angle_space)
        # import pdb; pdb.set_trace() ## DEBUG ##
